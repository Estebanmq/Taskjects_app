...
public class AdaptadorProyectosEmpleadoRV extends RecyclerView.Adapter<AdaptadorProyectosRV.ViewHolder> {

    private List<Proyecto> listProyectos;
    private LayoutInflater mInflater;
    private Context context;

    public AdaptadorProyectosEmpleadoRV(List<Proyecto>listProyectos, Context context) {
    ...
    public AdaptadorProyectosRV.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new AdaptadorProyectosRV.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdaptadorProyectosRV.ViewHolder holder, int position) {
